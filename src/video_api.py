...
# TODO: fix initialisation, seeking and "iteration"
#       for iteration, when we reach the end of the frames, we should
#       rest to the start of the frames and then
#       return False so the user can exit a loop i.e. while input.next()
